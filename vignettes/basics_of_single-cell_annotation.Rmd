...
```{r}
data_path <- system.file("data", "hippocampus_processed.rda", package = "SCMultiomeCNRSR")
load(file=data_path)
...
```{r}
data_path <- system.file("data", "cluster1.markers_RNA_snn_res.0.1.rda", package = "SCMultiomeCNRSR")

if(!file.exists(data_path)) {
  cluster1.markers <- FindMarkers(seu, ident.1 = 1, test.use = "wilcox", min.pct=0.01)
  save(cluster1.markers, file=data_path)
} else {
  load(file=data_path)
