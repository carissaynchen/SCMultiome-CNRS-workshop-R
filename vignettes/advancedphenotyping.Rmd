...
```{r}
data_path <- system.file("data", "hippocampus_minimal.rda", package = "SCMultiomeCNRSR")
load(file=data_path)
...
- Do the results vary when you use a different dimensionality technique or vary the selection of features?
...
data_path <- system.file("data", "slingshot_umap.rda", package = "SCMultiomeCNRSR")
if (!file.exists(data_path)) {
  slingshot_umap <- fitGAM(slingshot_umap,
                           ...
                           family = "nb",
                           gcv = FALSE)
  save(slingshot_umap, file = data_path)
} else {
  load(file=data_path)
}
...
```{r warning=FALSE}
data_path <- system.file("data", "scHOT_obj.rda", package = "SCMultiomeCNRSR")
if(!file.exists(data_path)) {
